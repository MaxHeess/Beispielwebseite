    ...
    <div id="menu">
      ...
      <ul id="leftmenu">
        ...
        <div id="right">
            ...
            <p>Hast du Fragen zu unseren Produkten, benötigst Unterstützung oder möchtest dich einfach über unsere Angebote informieren? Wir stehen dir gerne zur Verfügung! Nutze dafür das untenstehende Kontaktformular, um uns bequem und schnell zu erreichen.<br><br>

            Unser Team hilft dir bei allen Anliegen rund um Motorräder, Zubehör und Services weiter. Ob du auf der Suche nach deinem Traum-Motorrad bist oder technische Unterstützung benötigst – wir sind für dich da!<br><br>

            Wir freuen uns darauf, von dir zu hören!</p>
        </div>
          <div id="right2">
            <form action="kontakt_anfrage.php" method="POST">
