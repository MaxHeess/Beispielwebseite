...
<div class="header">
    ...
    <div id="menu">
        ...
        <ul id="leftmenu">
            ...
            <div id="right">
                <h3>Geben Sie Ihre E-Mail-Adresse ein und klicken Sie auf "Neues Passwort". Sie erhalten nach kurzer Zeit eine E-Mail. Folgen Sie den Hinweisen in der E-Mail, um Ihr Passwort zu ändern.</h3>
            </div>
          <div id="right2">
            ...
            <form action="anfrage_verarbeiten.php" method="POST">
                            ...
                            <button type="submit" class="styled-button">Neues Passwort</button><br><br>
                            <button class="styled-button" onclick="window.location.href='login.php';">Zurück zur Anmeldung</button>
